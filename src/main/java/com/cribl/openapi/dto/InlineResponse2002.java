...
public class InlineResponse2002 {
  ...
  private List<KeyMetadataEntity> items = null;
  ...
  **/
  ...
  public InlineResponse2002 items(List<KeyMetadataEntity> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2002 addItemsItem(KeyMetadataEntity itemsItem) {
    if (this.items == null) {
  ...
  **/
  @Schema(description = "")
  public List<KeyMetadataEntity> getItems() {
    return items;
  }

  public void setItems(List<KeyMetadataEntity> items) {
    this.items = items;
  }
