...
import com.cribl.openapi.dto.ScriptLibEntry;
...
public class InlineResponse20010 {
  ...
  private List<ScriptLibEntry> items = null;
  ...
  **/
  ...
  public InlineResponse20010 items(List<ScriptLibEntry> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20010 addItemsItem(ScriptLibEntry itemsItem) {
    if (this.items == null) {
  ...
  **/
  @Schema(description = "")
  public List<ScriptLibEntry> getItems() {
    return items;
  }

  public void setItems(List<ScriptLibEntry> items) {
    this.items = items;
  }
