...
public class OutputStatusDatadogMetrics implements OneOfOutputStatusStatusMetrics {
  ...
  public OutputStatusDatadogMetrics persistentQueueSize(BigDecimal persistentQueueSize) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics numBytesInBuffer(BigDecimal numBytesInBuffer) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics numEventsInBuffer(BigDecimal numEventsInBuffer) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics concurrentRequests(BigDecimal concurrentRequests) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics lastFlushTime(BigDecimal lastFlushTime) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics sentCount(BigDecimal sentCount) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics numDropped(BigDecimal numDropped) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics parseErrorCount(BigDecimal parseErrorCount) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics numLogs(BigDecimal numLogs) {
  ...
  **/
  ...
  public OutputStatusDatadogMetrics numMetrics(BigDecimal numMetrics) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OutputStatusDatadogMetrics outputStatusDatadogMetrics = (OutputStatusDatadogMetrics) o;
    return Objects.equals(this.persistentQueueSize, outputStatusDatadogMetrics.persistentQueueSize) &&
        Objects.equals(this.numBytesInBuffer, outputStatusDatadogMetrics.numBytesInBuffer) &&
        Objects.equals(this.numEventsInBuffer, outputStatusDatadogMetrics.numEventsInBuffer) &&
        Objects.equals(this.concurrentRequests, outputStatusDatadogMetrics.concurrentRequests) &&
        Objects.equals(this.lastFlushTime, outputStatusDatadogMetrics.lastFlushTime) &&
        Objects.equals(this.sentCount, outputStatusDatadogMetrics.sentCount) &&
        Objects.equals(this.numDropped, outputStatusDatadogMetrics.numDropped) &&
        Objects.equals(this.parseErrorCount, outputStatusDatadogMetrics.parseErrorCount) &&
        Objects.equals(this.numLogs, outputStatusDatadogMetrics.numLogs) &&
        Objects.equals(this.numMetrics, outputStatusDatadogMetrics.numMetrics);
  }
  ...
  public String toString() {
    ...
    sb.append("class OutputStatusDatadogMetrics {\n");
