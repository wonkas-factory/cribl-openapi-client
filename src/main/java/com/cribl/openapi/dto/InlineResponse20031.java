...
import com.cribl.openapi.dto.Condition;
...
public class InlineResponse20031 {
  ...
  public InlineResponse20031 count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20031 items(List<Condition> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20031 addItemsItem(Condition itemsItem) {
    if (this.items == null) {
