...
public class OutputStatusGrafanaCloudMetrics implements OneOfOutputStatusStatusMetrics {
  ...
  public OutputStatusGrafanaCloudMetrics persistentQueueSize(BigDecimal persistentQueueSize) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics numBytesInBuffer(BigDecimal numBytesInBuffer) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics numEventsInBuffer(BigDecimal numEventsInBuffer) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics concurrentRequests(BigDecimal concurrentRequests) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics lastFlushTime(BigDecimal lastFlushTime) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics sentCount(BigDecimal sentCount) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics numDropped(BigDecimal numDropped) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics parseErrorCount(BigDecimal parseErrorCount) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics numLogs(BigDecimal numLogs) {
  ...
  **/
  ...
  public OutputStatusGrafanaCloudMetrics numMetrics(BigDecimal numMetrics) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OutputStatusGrafanaCloudMetrics outputStatusGrafanaCloudMetrics = (OutputStatusGrafanaCloudMetrics) o;
    return Objects.equals(this.persistentQueueSize, outputStatusGrafanaCloudMetrics.persistentQueueSize) &&
        Objects.equals(this.numBytesInBuffer, outputStatusGrafanaCloudMetrics.numBytesInBuffer) &&
        Objects.equals(this.numEventsInBuffer, outputStatusGrafanaCloudMetrics.numEventsInBuffer) &&
        Objects.equals(this.concurrentRequests, outputStatusGrafanaCloudMetrics.concurrentRequests) &&
        Objects.equals(this.lastFlushTime, outputStatusGrafanaCloudMetrics.lastFlushTime) &&
        Objects.equals(this.sentCount, outputStatusGrafanaCloudMetrics.sentCount) &&
        Objects.equals(this.numDropped, outputStatusGrafanaCloudMetrics.numDropped) &&
        Objects.equals(this.parseErrorCount, outputStatusGrafanaCloudMetrics.parseErrorCount) &&
        Objects.equals(this.numLogs, outputStatusGrafanaCloudMetrics.numLogs) &&
        Objects.equals(this.numMetrics, outputStatusGrafanaCloudMetrics.numMetrics);
  }
  ...
  public String toString() {
    ...
    sb.append("class OutputStatusGrafanaCloudMetrics {\n");
