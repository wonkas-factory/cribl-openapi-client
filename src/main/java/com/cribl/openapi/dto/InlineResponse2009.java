...
public class InlineResponse2009 {
  ...
  private List<SavedJob> items = null;
  ...
  **/
  ...
  public InlineResponse2009 items(List<SavedJob> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2009 addItemsItem(SavedJob itemsItem) {
    if (this.items == null) {
  ...
  **/
  @Schema(description = "")
  public List<SavedJob> getItems() {
    return items;
  }

  public void setItems(List<SavedJob> items) {
    this.items = items;
  }
